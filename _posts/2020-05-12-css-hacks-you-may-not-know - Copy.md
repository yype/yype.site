...
随着存储技术的发展，程序的体积不再像以前那样影响着人们对体系结构的选择，这使得研究者对于OISC有了新的考量：Laplante等将OISC用于图像处理[2]，得到了超乎想象的性能提升；Tsoutsos等将OISC用于处理加密数据[3]，相较传统体系结构而言，OISC对数据的处理更加模糊与隐蔽，具有更高的安全性。
